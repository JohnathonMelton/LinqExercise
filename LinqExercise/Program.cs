...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var descOder = numbers.OrderByDescending(num => num);

            Console.WriteLine("");
            Console.WriteLine("----------");
            Console.WriteLine("");

            foreach (var number in descOder)
            {
                Console.WriteLine(number);
            }
            ...
            foreach (var number in descOder.Take(4))
            {
                Console.WriteLine(number);
            }
            ...
            employees = employees.Append(new Employee("Jackson", "Grimm", 27, 10)).ToList();
